    ...
    <form action="{{ route('admin.applications.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            ...
            <div class="form-card card">
                <div style="display: flex; align-items: center; gap: 1rem; margin-block-end: 1.5rem; padding-block-end: 1rem; border-block-end: 1px solid #F3F4F6;">
                    <div class="stat-icon" style="width: 2.5rem; height: 2.5rem;">
                        <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                    </div>
                    <h3 style="margin: 0; color: var(--primary);">البيانات الشخصية لمقدم الطلب</h3>
                </div>
                ...
                <div class="responsive-grid-2" style="display: grid; gap: 1rem; margin-block-end: 1.5rem;">
                ...
                <div class="form-group">
                    ...
                    <textarea name="address" id="address" class="form-input" style="height: 100px;" placeholder="المحافظة - المديرية - الشارع">{{ old('address') }}</textarea>
                </div>
            </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                ...
                <div class="card" style="padding: 1.5rem;">
                    <h3 style="margin: 0 0 1rem 0; font-size: 1rem; color: var(--primary);">الصورة الشخصية</h3>
                    <div class="photo-upload-box" onclick="document.getElementById('photo').click()">
                        ...
                        <div id="photo-preview-container">
                            ...
                            <p style="margin: 0.5rem 0 0 0; font-size: 0.75rem; color: var(--placeholder);">خلفية بيضاء - 4x6 - Max 2MB</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Application Meta -->
                <div class="card" style="padding: 1.5rem;">
                    <h3 style="margin: 0 0 1rem 0; font-size: 1rem; color: var(--primary);">جهة الإصدار</h3>
                    <div class="form-group">
                ...
                <div style="margin-block-start: 1rem;">
                    <button type="submit" class="btn-figma-gold" style="width: 100%; box-shadow: 0 4px 6px -1px rgba(200, 165, 95, 0.2);">
                    ...
                    <a href="{{ route('admin.applications.index') }}" style="display: block; text-align: center; margin-block-start: 1rem; color: var(--text-muted); text-decoration: none; font-size: 0.85rem;">إلغاء والعودة للقائمة</a>
                </div>
            </div>
        </div>
    </form>
    ...
    function previewImage(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                container.innerHTML = `
                    <img src="${e.target.result}" style="width: 120px; height: 160px; object-fit: cover; border-radius: 8px; margin-inline: auto; margin-block-end: 12px; border: 4px solid white; box-shadow: var(--shadow-md);">
