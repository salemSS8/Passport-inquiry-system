...
<div class="welcome-header" style="margin-block-end: var(--space-lg);">
    <h1 style="font-size: 1.75rem; font-weight: 800; color: var(--primary); margin: 0;">مرحباً بك، {{ Auth::user()->name }}</h1>
    <p style="color: var(--text-muted); margin-block-start: 4px;">آخر دخول لك كان: {{ now()->subHours(2)->format('Y-m-d h:i A') }}</p>
</div>
...
<div class="bento-grid">
    ...
    <div class="stat-card">
        <div class="stat-icon" style="background: rgba(59, 130, 246, 0.1); color: #3B82F6;">
            <svg style="inline-size: 24px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
        </div>
        <div>
            <div class="stat-value">{{ \App\Models\PassportApplication::whereIn('status', ['pending', 'processing'])->count() }}</div>
            <div class="stat-label">قيد المعالجة</div>
        </div>
    </div>
    <div class="stat-card">
        <div class="stat-icon" style="background: rgba(16, 185, 129, 0.1); color: #10B981;">
            <svg style="inline-size: 24px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
        </div>
        <div>
    ...
    <div class="stat-card">
        <div class="stat-icon" style="background: rgba(245, 158, 11, 0.1); color: #F59E0B;">
            <svg style="inline-size: 24px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path></svg>
        </div>
        <div>
...
<div class="grid grid-2" style="gap: var(--space-lg); align-items: start;">
    ...
    <div class="table-container">
        <div style="padding: 24px; border-block-end: 1px solid #E5E7EB; display: flex; justify-content: space-between; align-items: center;">
            <h3 style="margin: 0; font-size: 1.1rem; color: var(--primary);">آخر الطلبات المضافة</h3>
            <a href="{{ route('admin.applications.index') }}" style="color: var(--accent); font-weight: 600; text-decoration: none; font-size: 0.9rem;">عرض الكل</a>
        </div>
    ...
    <!-- Quick Actions -->
    <div class="form-card">
        <h3 style="margin-block-end: var(--space-md); color: var(--primary);">إجراءات سريعة</h3>
